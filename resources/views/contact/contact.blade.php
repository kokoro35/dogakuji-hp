...
<div class="container form-container" id="googleform">
    ...
    <form action="https://docs.google.com/forms/u/0/d/e/1FAIpQLScYCjoZklzlmUQTeyABZx0ZeHbLUuDGG4H8x5AfKpZsXfywtA/formResponse">
        <div class="form-group">
            ...
            <input type="submit" class="btn btn-primary gform-btn">
        </div>
